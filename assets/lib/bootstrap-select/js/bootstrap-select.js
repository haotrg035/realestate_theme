  ...
  (function ($) {
    ...
    Selectpicker.prototype = {
      ...
      render: function () {
        ...
        if (this.options.prefixLabel) {
          let prefixLabel = document.createElement('small');
          let _titleFragment = null;

          if (this.options.prefixLabelVerticle) {
            _titleFragment = document.createElement('p');
          } else {
            _titleFragment = document.createElement('span');
          }
          prefixLabel.classList = 'text-muted';
          prefixLabel.innerHTML = this.options.prefixLabel;
          buttonInner.appendChild(prefixLabel);
          _titleFragment.classList = 'font-weight-bold mb-0';
          _titleFragment.innerHTML = titleFragment.textContent;
          titleFragment = _titleFragment;
        }
